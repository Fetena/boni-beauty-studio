...
// Local image assets — run fetch-images.sh once to populate the 9 stock
// photos below; the bridal photos and promo posters are already included.
import heroEditorialStyling from './assets/hero-editorial-styling.jpg';
import bridalCategoryBg from './assets/bridal-category-bg.jpg';
import stylingCategoryBg from './assets/styling-category-bg.jpg';
import classicEleganceImg from './assets/classic-elegance.jpg';
import bohoChicImg from './assets/boho-chic.jpg';
import customHairColorImg from './assets/custom-hair-color.jpg';
import precisionCuttingImg from './assets/precision-cutting.jpg';
import modernGlamStylingImg from './assets/modern-glam-styling.jpg';
import aboutStudioImg from './assets/about-studio.jpg';
import bridalCurledBraidImg from './assets/bridal-curled-braid.jpg';
import bridalFloralPearlUpdoImg from './assets/bridal-floral-pearl-updo.jpg';
import promoPoster1Img from './assets/promo-poster-1.jpg';
import promoPoster2Img from './assets/promo-poster-2.jpg';

const servicesData = {
  "Editorial & Bridal": {
    title: "Editorial & Bridal",
    bgImg: bridalCategoryBg,
    desc: "Our signature bridal service is designed to make you feel radiant and timeless.",
    items: [
      { name: "Classic Elegance", img: classicEleganceImg, desc: "Timeless and sophisticated look.", duration: "90 min", priceFrom: "2,200 ETB" },
      { name: "Boho Chic", img: bohoChicImg, desc: "Soft, romantic styles.", duration: "75 min", priceFrom: "1,900 ETB" },
      { name: "Modern Glam", img: modernGlamStylingImg, desc: "Bold, trendy, high-fashion.", duration: "100 min", priceFrom: "2,500 ETB" },
      { name: "Curled Bridal Braid", img: bridalCurledBraidImg, desc: "Cascading curls swept into a romantic braid.", duration: "110 min", priceFrom: "2,400 ETB" },
      { name: "Floral Pearl Updo", img: bridalFloralPearlUpdoImg, desc: "Soft updo finished with delicate floral pins.", duration: "95 min", priceFrom: "2,100 ETB" }
    ]
  },
  "Signature Styling": {
    title: "Signature Styling",
    bgImg: stylingCategoryBg,
    desc: "Precision cutting and master-level color theory designed for your lifestyle.",
    items: [
      { name: "Custom Hair Color", img: customHairColorImg, desc: "Customized color treatments.", duration: "120 min", priceFrom: "1,800 ETB" },
      { name: "Precision Cutting", img: precisionCuttingImg, desc: "Sharp, clean lines.", duration: "45 min", priceFrom: "700 ETB" },
      { name: "Styling & Extensions", img: modernGlamStylingImg, desc: "Fullness and length.", duration: "60 min", priceFrom: "1,200 ETB" }
    ]
  }
};
...
const heroImages = [
  { src: heroEditorialStyling, caption: "Editorial styling, finished to perfection" },
  { src: bridalCategoryBg, caption: "Bridal looks built to last the whole day" },
  { src: stylingCategoryBg, caption: "Precision color, custom to you" },
  { src: classicEleganceImg, caption: "Classic elegance, modern technique" },
  { src: bohoChicImg, caption: "Soft, romantic, effortless" },
  { src: customHairColorImg, caption: "Color theory, mastered" },
  { src: precisionCuttingImg, caption: "Sharp lines, expert hands" },
  { src: promoPoster1Img, caption: "Book your next visit today" },
  { src: promoPoster2Img, caption: "Take care of your hair, it's a crown" }
];
    ...
    <div className="min-h-screen bg-[#FDFBF5] text-[#0A1D2F] font-sans pb-24 md:pb-0">
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 md:pb-24">
        <div className="text-center mb-10">
          <span className="text-[#C8B87B] font-bold tracking-widest text-[10px] uppercase">Limited Time</span>
          <h2 className="text-4xl font-serif mt-2">Current Promotions</h2>
        </div>
